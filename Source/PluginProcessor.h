...
public:
    ...
    // Persisted editor window size (saved in plugin state; restored on reopen). Width drives it;
    // height follows the locked aspect ratio (~1.328).
    int editorW = 1080, editorH = 813;
